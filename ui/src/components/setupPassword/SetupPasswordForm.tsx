...
import { useSetupPassword } from "@/hooks/query/useAuthentication";
...
const SetupPasswordForm: FC<SetupPasswordFormProps> = ({
  token,
  ...
  const { mutateAsync: setupPassword, isLoading } = useSetupPassword();
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        >
          {!isLoading ? "Setup Password" : ""}
          {isLoading && (
            <>
              <p className="p-2">Setting up password</p>
